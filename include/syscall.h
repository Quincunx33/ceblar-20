...
enum {SYS_READ=0,SYS_WRITE=1,SYS_OPEN=2,SYS_CLOSE=3,SYS_FORK=4,SYS_EXIT=5,SYS_GETPID=6,SYS_YIELD=7,SYS_SLEEP=8,SYS_WAIT=9,SYS_EXEC=10,SYS_MMAP=11,SYS_UNAME=12,SYS_MUNMAP=13,SYS_COUNT=14};
