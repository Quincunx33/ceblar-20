...
typedef struct address_space {uint32_t page_directory[1024] __attribute__((aligned(4096)));uint32_t user_tables[8][1024] __attribute__((aligned(4096)));uint8_t table_used[8];vma_t vmas[VMM_MAX_VMAS];} address_space_t;
...
address_space_t *vmm_create_address_space(void); address_space_t *vmm_clone_address_space(address_space_t *source); address_space_t *vmm_clone_address_space_cow(address_space_t *source); void vmm_destroy_address_space(address_space_t *space); void vmm_switch_address_space(address_space_t *space); address_space_t *vmm_current_address_space(void); int vmm_map_user(address_space_t *space,uint32_t virt,uint32_t phys,uint32_t flags); uint32_t vmm_user_alloc(address_space_t *space,uint32_t virt,uint32_t pages,uint32_t flags); int vmm_map_range(address_space_t *space,uint32_t virt,uint32_t pages,uint32_t flags); int vmm_unmap_range(address_space_t *space,uint32_t virt,uint32_t pages); int vmm_unmap_user(address_space_t *space,uint32_t virt); uint32_t vmm_get_user_physical(address_space_t *space,uint32_t virt); int vmm_validate_user_ptr(address_space_t *space,uint32_t virt,uint32_t len,uint32_t write); int vmm_clone_selftest(void); int vmm_cow_selftest(void);
