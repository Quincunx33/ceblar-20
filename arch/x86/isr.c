...
void irq_handler(registers_t*r){uint8_t irq=(uint8_t)(r->int_no-32);if(irq<16&&irq_handlers[irq])irq_handlers[irq](r);if(irq>=8)outb(0xa0,0x20);outb(0x20,0x20);apic_eoi();}
