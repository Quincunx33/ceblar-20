...
#include "mm.h"
#include "drivers.h"
#define MAX_PHYS_PAGES 262144u
#define BITMAP_BYTES (MAX_PHYS_PAGES / 8u)
#define TAG_MMAP 6u
#define MMAP_AVAILABLE 1u
static uint8_t page_bitmap[BITMAP_BYTES]; static uint32_t total_pages_count, used_pages_count;
